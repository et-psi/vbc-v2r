          ...
          <div class="main-content">
            <!--/soccer-inner-->
                <div class="soccer-inner">
                        <div class="top-inner">
                        <h4 class="side">Gestionnaire de diaporama</h4>


<!-- Advanced Tables -->
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Gestion du slideshow de l'équiqpe : NOM_équipe   <?php echo ' <a href="./slideshow-manager.php?action=add&id=' . $user[0] . '"><span class="glyphicon glyphicon-plus-sign"></span> Pour ajouter cliquez ici</a>'; ?>
                        </div>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <tr class="odd gradeX">
                                            ...
                                            <td>
                                                <?php echo ' <a href="./slideshow-manager.php?action=edit&id=' . $user[0] . '"><span class="glyphicon glyphicon-edit"></span></a>'; ?>
                                                <?php echo ' <a href="./slideshow-manager.php?action=delete&id=' . $user[0] . '"><span class="glyphicon glyphicon-trash"></span></a>'; ?>
                                            </td>
                                        </tr>
                                        <tr class="odd gradeC">
                                            <td>1</td>
